...
ARGS="--url=http://$(hostname -I | cut -f2 -d " "):9000/ --port=9000 --workdir=raft --othernodes=[$1:9000/] --socket=tm.ipc  --publickeys=constellation.pub --privatekeys=constellation.key --verbosity=3"
...
echo "[*] Starting geth"
PRIVATE_CONFIG=raft/tm.ipc nohup geth --datadir qdata $GLOBAL_ARGS --rpccorsdomain "*" --rpcport 22000 --port 21000 --raftport 23000 --unlock 0 --password passwords.txt 2>>qdata/logs/geth.log &
